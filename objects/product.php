<?php
    class Product{
        ...
        function uploadPhoto() {
            ...
            // comprobamos que hay una imagen en el atributo de producto
            if ($this->image) {
                ...
                // comprobamos que la imagen es real
                ...
                // comprobamos que la extensión es la permitida
                if (!in_array($file_type, $allowed_file_types)) {
                    $file_upload_error_messages .= "<div> Only jpg, jpeg, png, gif are allowed  </div>";
                }
                
                // make sure file does not exist
                // comprobamos que no exista ya la imagen
                if (file_exists($target_file)) {
                    $file_upload_error_messages .= "<div> Image already exists. Try to change file name. </div>";
                }
                
                // make sure submitted file is not too large, can't be larger than 1 MB
                // comprobamos que el archivo no supere 1 MB
                ...
                // if not, create it
                // comprobamos que el directorio existe, si no es así, lo creamos.
